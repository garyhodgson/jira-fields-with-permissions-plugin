...
public class RestrictedMultiUserCFType extends MultiUserCFType {

    public RestrictedMultiUserCFType(CustomFieldValuePersister customFieldValuePersister, StringConverter stringConverter,
        ...
        super(customFieldValuePersister, stringConverter, genericConfigManager, multiUserConverter, applicationProperties, authenticationContext, searchService, fieldVisibilityManager);
    }
    ...
    public void updateValue(CustomField customField, Issue issue, Object value) {
        ...
        if (FiberlinkUtilities.isAllowedToSee("" + customField.getIdAsLong(), user, issue, "edit").booleanValue()) {
            if (value == null || ((List) value).size() == 0 || !(((User) (((List) value).get(0))).getName().equals(""))) {
