...
public class RestrictedMultiSelectCFType extends MultiSelectCFType {

    public RestrictedMultiSelectCFType(OptionsManager optionsManager, CustomFieldValuePersister valuePersister,
    ...
    public void updateValue(CustomField customField, Issue issue, Object value) {
        ...
        if (FiberlinkUtilities.isAllowedToSee("" + customField.getIdAsLong(), user, issue, "edit").booleanValue()) {
            if (value == null || ((List) value).size() == 0 || !(((String) (((List) value).get(0))).equals("p#w/B0uX2i5"))) {
