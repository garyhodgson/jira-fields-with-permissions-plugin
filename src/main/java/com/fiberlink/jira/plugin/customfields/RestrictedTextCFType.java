...
public class RestrictedTextCFType extends TextCFType {

    public RestrictedTextCFType(CustomFieldValuePersister customFieldValuePersister, StringConverter stringConverter,
